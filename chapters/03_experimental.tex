...
Protons used for acceleration in the LHC are extracted from a so-called duoplasmatron hydrogen source 
which ionizes hydrogen atoms at the CERN main site. These molecules are stripped of their electrons by strong electric fields
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\textwidth]{../figs/lhc_scheme.pdf}
