...
of those superlayers are then combined into one DT, with altering orientation of the wires to provide maximum spacial resolution. RPCs are glued to either side of a DT. The gas in the 
...
Because of the much higher flux in the forward part of the detector, a more robust detector design had to be chosen for high values of $|\eta|$




Using only the muon system, a resolution of 
