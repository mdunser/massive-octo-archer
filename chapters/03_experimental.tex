...
paramount importance. However, since the available volume within the CMS magnet is limited, a compromise on the hadronic calorimeter
...
The geometry is again divided into a barrel (HB) and an endcap (HE) part. The HB consists of one steel plate in the very front of the detector
and another one at the very end of the detector. In between, the absorber material is brass of variable thickness. In total, the barrel consists
of 5.82 interaction lengths of material at $\eta$ = 0 up to 10.6 interaction lengths at $|\eta|$ = 1.3. 
