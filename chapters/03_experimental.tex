...
calorimeters are contained within the superconducting magnet, as shown in a sketch of the CMS calorimetry in Fig.~\ref{fig:calo}. 

The electromagnetic calorimeter (ECAL) is a homogeneous calorimeter made of \num{68524} lead tungstate (PbWO$_3$) crystals. This material was chosen
...
the energy of an incoming particle has decreased to $\frac{1}{e}\simeq$38\%, while the Moli\`{e}re radius denotes the transverse containment of an 
...
include a very short signal collection time of about 25 \si{\nano\second} for 80\% of the signal and a relatively low photoelectron output of
...
and amplified by photomultipliers which are mounted to the rear end of the crystals.
...
in radial direction is 230 \si{\milli\meter}, corresponding to \num{25.8} radiation lengths. The barrel part of the ECAL extends to 
|$\eta$| = 1.479, and the endcap part covers the pseudorapidity range from 1.479 < |$\eta$| < 3.0.

The design of the ECAL was driven by the necessary resolution to discover the Higgs boson decay into two photons.
...
the center of the detecteo, while the hadronic calorimeter extends to larger radii~\cite{cmsdetector}.}
    \label{fig:cms_calo}
\end{figure}
