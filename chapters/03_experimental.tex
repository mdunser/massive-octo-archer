...
the integrated luminosity $\mathfrak{L}_{int}$ is obtained. Through knowledge of the latter, one can calculate the total number
...
it is cylindrically shaped with dimensions of roughly 22 meters in length and a diameter of about 16 meters. It comprises
a barrel part in the center and a so-called endcap on either side to seal the detector as hermetically as possible.
...
structure and the conducting material is a niobium-titanium alloy, albeit at a very different scale. It measures roughly 6 
meters in diameter and 11 (FIXME) meters in length, carrying a current of about FIXME ampere.
