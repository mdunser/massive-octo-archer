...
20 to 116 cm and is also divided into a cylindrical barrel part and endcap parts perpendicular to the beam direction. The naming scheme of the 
...
Tracker Inner Disks (TID) and the Tracker EndCaps (TEC) for the perpendicular part. Altogether, a particle traversing the strip tracker will
hit about ten active silicon layers\footnote{This depends on the exact trajectory.}, resulting in outstanding impact parameter resolution of 
around 10 \si{\micro\meter}.
